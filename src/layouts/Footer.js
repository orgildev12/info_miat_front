...
const navigation = {
    links: [
        { name: 'Аялалд гарахын өмнө', href: '#' },
        { name: 'Авч явахыг хориглох зүйлс', href: '#' },
        { name: 'Онгоцны танилцуулга', href: '#' },
        { name: 'Түгээмэл асуулт', href: '#' },
        { name: 'МИАТ аппликейшн', href: '#' },
        { name: 'Тусгай үнэ', href: '#' },
        { name: 'Үнэ, тариф', href: '#' },
    ],
    support: [
        { name: 'Танилцуулга', href: '#' },
        { name: 'Үүсгэн байгуулагч', href: '#' },
        { name: 'Захирлын мэндчилгээ', href: '#' },
    ...
    social: [
        {
            name: 'Facebook',
            href: 'https://www.facebook.com/MIAT.Official.Page',
            icon: (props) => (
        ...
        {
            name: 'YouTube',
            href: 'https://www.youtube.com/@miat_mongolianairlines',
            icon: (props) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
                        fillRule="evenodd"
